...
import static com.test.uat.TC_01_Bet.ID_04_GetFootballSportTree.*;


public class ID_05_PlaceBet extends BasicSetup {

    public static String betSlipId;
    protected static  int integerDecimalOdd;
    protected static String stringIntDecimalOdd;
    protected static Double doubDecimalOdd;
    protected static String stringDoubleDecimalOdd;
    ...
    public void placeBet(Method testMethod) throws Exception {
        ...
        try {
            selectionDecimal = JsonPath.read(jsonResponse, "$.PlaceBetsResponse.betPlacementResult[0].betPartPlacementResult[0].odds.decimal");
        } catch (Exception e) {
            e.printStackTrace();
        }
