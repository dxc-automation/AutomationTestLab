package com.demo.scripts.ui.products_page.bonds;
...
public class OpenBondsPage extends BasicTestConfig {
    ...
    private static void report() throws Exception {
        String testName        = "<b>Open bonds page</b>";
    ...
    public static void openBondsPage() throws Exception {
        report();
        ...
        wait.until(ExpectedConditions.visibilityOf(productsBasic.header_menu_bonds_btn));
        productsBasic.header_menu_bonds_btn.click();
        test.pass("<b>[STEP 2]</b> Bonds products page was opened successfully");
