package com.demo.scripts.ui.products_page.etfs;
...
public class OpenEtfsPage extends BasicTestConfig {
    ...
    public static void openEtfsPage() throws Exception {
        report();
        ...
        test.pass("<b>[STEP 2]</b> ETFs products page was opened successfully");
