package com.demo.scripts.ui.amazon;

import com.demo.config.BasicTestConfig;
import com.demo.objects.Amazon.AmazonHomePage;
...
public class Amazon extends BasicTestConfig {

    private static final Logger LOG  = LogManager.getLogger(Amazon.class);
    private static AmazonHomePage homePage   = PageFactory.initElements(driver, AmazonHomePage.class);
    ...
    public static void load(String homePageTitle) {
