...
public class INT_SearchProduct {
    ...
    static final Logger LOG = LogManager.getLogger(INT_SearchProduct.class);

    private static void report() throws Exception {
        String testName        = "<b>[GET] SearchFromPlaceOrderSidePanel Product</b>";
