...
public class SearchProductStocks {
    ...
    static final Logger LOG = LogManager.getLogger(SearchProductStocks.class);
    ...
    public static void searchStocks(String fileName, int limit) throws Exception {
        report();
        ...
        url = new URIBuilder()
                ...
                .setParameter("indexId",          "9")
                .setParameter("stockCountryId",   "923")
