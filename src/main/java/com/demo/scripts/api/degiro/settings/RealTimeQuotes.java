package com.demo.scripts.api.degiro.settings;
...
public class RealTimeQuotes {
    ...
    static final Logger LOG = LogManager.getLogger(RealTimeQuotes.class);
    ...
    public static void getRealTimeQuotesStates(String fileName) throws Exception {
        report();

        scheme = "https";
        host   = INTERNAL_HOST;
        path   = INTERNAL_REAL_QUOTES;
