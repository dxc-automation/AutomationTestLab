...
public class SearchBonds {
    ...
    static final Logger LOG = LogManager.getLogger(SearchBonds.class);

    private static void report() throws Exception {
        String testName        = "<b>[GET] SearchBonds List</b>";
    ...
    public static void getBonds(String fileName, int limit, boolean requireTotal) throws Exception {
        report();
        ...
        url = new URIBuilder()
                ...
                .addParameter("bondIssuerTypeId", "0")
